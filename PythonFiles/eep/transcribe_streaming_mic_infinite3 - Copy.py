...
os.system('cls')
print("")
print("Using PyAudio module to pick up microphone audio at a rate of 16khz, chunking at 100ms chunks")
print("")
print("going from ",  time.time(), " to ", t_end)
# Audio recording parameters
RATE = 16000
CHUNK = int(RATE / 10)  # 100ms

# start the output file write
...
class MicrophoneStream(object):
    ...
    def __enter__(self):
        ...
        self._audio_stream = self._audio_interface.open(
            ...
            stream_callback=self._fill_buffer, as_loopback = useloopback
        )
...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        if not result.is_final and t_end > time.time():
